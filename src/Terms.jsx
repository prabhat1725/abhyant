...
const Terms = () =>{
    return(
        <div className="terms p-28">
            <h1 className="mb-32">Terms & conditions</h1>
...
<div className="mb-28">
<h4 className="mb-16">Non-Transferable</h4>
...
<div className="mb-28">
<h4 className="mb-16">Disclaimer</h4>
...
<div className="mb-28">
<h4 className="mb-16">Use of Information</h4>
...
<div className="mb-28">
<h4 className="mb-16">Privacy Policy</h4>
Our Privacy Policy, as it may change from time to time, is a part of this Agreement.
</div>
<div className="mb-28">
<h4 className="mb-16">Links to Other Web Sites</h4>
The Site contains links to other Web sites. We are not responsible for the content, accuracy or opinions express in such Web sites, and such Web sites are not investigated, monitored or checked for accuracy or completeness by us. Inclusion of any linked Web site on our Site does not imply approval or endorsement of the linked Web site by us. If you decide to leave our Site and access these third-party sites, you do so at your own risk.
</div>
<div>
<h4 className="mb-16">Information and Press Release</h4>
